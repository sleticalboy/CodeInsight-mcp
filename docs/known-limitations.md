...
- Extend blocked/empty-state contracts beyond `blocked_no_seed` and
  `blocked_invalid_seed` so agents receive actionable next steps instead of
  broad-reading when other context routes cannot be inferred.

...
- Python absolute `from ... import name as alias` imports can provide `callee_file` hints for direct alias calls such as `shared_ping()` when the resolved local package file contains the imported symbol.

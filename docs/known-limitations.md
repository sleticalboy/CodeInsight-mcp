...
- Non-literal dynamic `import()`, external dynamic import handlers, variable-based `require(...)` targets, package exports, TypeScript path aliases, and bundler resolution are not modeled yet.

...
`/tmp/codeinsight-self-adoption-report.tar.gz` archive path, `540/78072`
routed first-read metric, route-quality summary, type-relation routing fields,
and MCP first-call contract booleans when `release-evidence/<tag>.json` was
generated by the current evidence script.

...
`/tmp/codeinsight-self-adoption-report.tar.gz` archive path, `440/39357`
routed first-read metric, type-relation routing fields, and MCP first-call
contract booleans when `release-evidence/<tag>.json` was generated by the
current evidence script.

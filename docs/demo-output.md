...
3. context_pack
   ...
   routing_decision_read_less: 99.3%, 149.9x
...
[Evidence summary]
Blind first-read baseline: 79890 source lines.
...
agent_route selected 533/79890 source lines (99.3% reduction) across 3 files.
...
6. routing_decision summarizes the same choice: seed=task_match:src/tools.rs, first_file=src/tools.rs, rank=1, read_less=99.3%/149.9x.

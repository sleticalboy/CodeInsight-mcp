...
3. context_pack
   ...
   blind_first_read_lines: 78200
   routed_first_read_lines: 553
   selected_lines: 553
   source_lines_avoided: 77647
   line_reduction: 99.3%
   read_less_ratio: 141.4x
...
[Evidence summary]
Blind first-read baseline: 78200 source lines.
Routed first-read: 553 source lines across 3 files.
Read less: avoided 77647 source lines, 141.4x less text before follow-up tools.
...
agent_route selected 553/78200 source lines (99.3% reduction) across 3 files.
...
6. routing_decision summarizes the same choice: seed=task_match:src/tools.rs, first_file=src/tools.rs, rank=1, read_less=99.3%/141.4x.

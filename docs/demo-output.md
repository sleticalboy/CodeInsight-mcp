...
3. context_pack
   ...
   routing_decision_read_less: 99.4%, 164.4x
   ...
   blind_first_read_lines: 84651
   routed_first_read_lines: 515
   selected_lines: 515
   source_lines_avoided: 84136
   line_reduction: 99.4%
   read_less_ratio: 164.4x
...
[Evidence summary]
Blind first-read baseline: 84651 source lines.
Routed first-read: 515 source lines across 2 files.
Read less: avoided 84136 source lines, 164.4x less text before follow-up tools.
...
agent_route selected 515/84651 source lines (99.4% reduction) across 2 files.
...
6. routing_decision summarizes the same choice: seed=task_match:src/tools.rs, first_file=src/tools.rs, rank=1, read_less=99.4%/164.4x.

...
3. context_pack
   ...
   routing_decision_read_less: 99.4%, 165.9x
   ...
   blind_first_read_lines: 88099
   routed_first_read_lines: 531
   selected_lines: 531
   source_lines_avoided: 87568
   line_reduction: 99.4%
   read_less_ratio: 165.9x
...
[Evidence summary]
Blind first-read baseline: 88099 source lines.
Routed first-read: 531 source lines across 1 files.
Read less: avoided 87568 source lines, 165.9x less text before follow-up tools.
...
agent_route selected 531/88099 source lines (99.4% reduction) across 1 files.
...
6. routing_decision summarizes the same choice: seed=task_match:src/tools.rs, first_file=src/tools.rs, rank=1, read_less=99.4%/165.9x.

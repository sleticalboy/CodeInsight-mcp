...
3. context_pack
   ...
   blind_first_read_lines: 80541
   routed_first_read_lines: 533
   selected_lines: 533
   source_lines_avoided: 80008
   line_reduction: 99.3%
...
[Evidence summary]
Blind first-read baseline: 80541 source lines.
Routed first-read: 533 source lines across 3 files.
Read less: avoided 80008 source lines, 151.1x less text before follow-up tools.
...
agent_route selected 533/80541 source lines (99.3% reduction) across 3 files.
...
16. The selected context avoided 80008 source lines (99.3%, 151.1x less text); selected 3 files, 12 ranges, and 3 reading-plan steps within the token budget; read src/tools.rs first (candidate rank 1) via inspect_seed_file, use file_outline when deeper evidence is needed; first omitted candidate src/embedding.rs (candidate rank 4, reason token_budget_exhausted) can be revisited via run_omitted_candidate_context_pack using context_pack after selected context; continuation run_omitted_candidate_context_pack

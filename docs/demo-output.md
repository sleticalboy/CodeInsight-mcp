...
3. context_pack
   ...
   routing_decision_read_less: 99.4%, 169.4x
...
[Evidence summary]
Blind first-read baseline: 93663 source lines.
...
agent_route selected 553/93663 source lines (99.4% reduction) across 1 files.
...
6. routing_decision summarizes the same choice: seed=task_match:src/tools.rs, first_file=src/tools.rs, rank=1, read_less=99.4%/169.4x.

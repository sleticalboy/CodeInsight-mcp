...
3. context_pack
   ...
   routing_decision_read_less: 99.4%, 163.9x
   ...
   blind_first_read_lines: 87184
   routed_first_read_lines: 532
   selected_lines: 532
   source_lines_avoided: 86652
   line_reduction: 99.4%
...
[Evidence summary]
Blind first-read baseline: 87184 source lines.
Routed first-read: 532 source lines across 2 files.
Read less: avoided 86652 source lines, 163.9x less text before follow-up tools.
...
agent_route selected 532/87184 source lines (99.4% reduction) across 2 files.
...
6. routing_decision summarizes the same choice: seed=task_match:src/tools.rs, first_file=src/tools.rs, rank=1, read_less=99.4%/163.9x.

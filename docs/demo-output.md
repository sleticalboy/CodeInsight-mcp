...
3. context_pack
   ...
   routing_decision_read_less: 99.4%, 163.4x
   ...
   blind_first_read_lines: 86939
   routed_first_read_lines: 532
   selected_lines: 532
   source_lines_avoided: 86407
   line_reduction: 99.4%
   read_less_ratio: 163.4x
...
[Evidence summary]
Blind first-read baseline: 86939 source lines.
Routed first-read: 532 source lines across 2 files.
Read less: avoided 86407 source lines, 163.4x less text before follow-up tools.
...
agent_route selected 532/86939 source lines (99.4% reduction) across 2 files.
...
6. routing_decision summarizes the same choice: seed=task_match:src/tools.rs, first_file=src/tools.rs, rank=1, read_less=99.4%/163.4x.

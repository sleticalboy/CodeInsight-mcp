...
3. context_pack
   ...
   routing_decision_read_less: 99.3%, 141.7x
...
6. routing_decision summarizes the same choice: seed=task_match:src/tools.rs, first_file=src/tools.rs, rank=1, read_less=99.3%/141.7x.

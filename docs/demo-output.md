...
3. context_pack
   ...
   blind_first_read_lines: 83024
   routed_first_read_lines: 537
   selected_lines: 537
   source_lines_avoided: 82487
   line_reduction: 99.4%
   read_less_ratio: 154.6x
...
[Evidence summary]
Blind first-read baseline: 83024 source lines.
Routed first-read: 537 source lines across 2 files.
Read less: avoided 82487 source lines, 154.6x less text before follow-up tools.
...
agent_route selected 537/83024 source lines (99.4% reduction) across 2 files.
...
6. routing_decision summarizes the same choice: seed=task_match:src/tools.rs, first_file=src/tools.rs, rank=1, read_less=99.4%/154.6x.

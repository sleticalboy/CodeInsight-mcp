...
3. context_pack
   ...
   routing_decision_read_less: 99.4%, 154.7x
   ...
   blind_first_read_lines: 83254
   routed_first_read_lines: 538
   selected_lines: 538
   source_lines_avoided: 82716
   line_reduction: 99.4%
   read_less_ratio: 154.7x
...
[Evidence summary]
Blind first-read baseline: 83254 source lines.
Routed first-read: 538 source lines across 2 files.
Read less: avoided 82716 source lines, 154.7x less text before follow-up tools.
...
agent_route selected 538/83254 source lines (99.4% reduction) across 2 files.
...
6. routing_decision summarizes the same choice: seed=task_match:src/tools.rs, first_file=src/tools.rs, rank=1, read_less=99.4%/154.7x.

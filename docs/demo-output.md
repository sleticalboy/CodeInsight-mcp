...
3. context_pack
   ...
   routing_decision_read_less: 99.4%, 176.4x
   ...
   blind_first_read_lines: 96142
   routed_first_read_lines: 545
   selected_lines: 545
   source_lines_avoided: 95597
   line_reduction: 99.4%
   read_less_ratio: 176.4x
...
[Evidence summary]
Blind first-read baseline: 96142 source lines.
Routed first-read: 545 source lines across 1 files.
Read less: avoided 95597 source lines, 176.4x less text before follow-up tools.
...
agent_route selected 545/96142 source lines (99.4% reduction) across 1 files.
...
6. routing_decision summarizes the same choice: seed=task_match:src/tools.rs, first_file=src/tools.rs, rank=1, read_less=99.4%/176.4x.

...
- `external-beta-cohort-report.sh` packages the cohort summary JSON/Markdown,
  fix queue JSON/Markdown, handoff README, ready-to-file handoff issue, and
  `manifest.json` into one folder for public Beta review; add
  `--print-snippet` to print a compact Markdown summary for quick terminal
  handoff.

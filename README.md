...
and Streamlit route-quality expectations pass `86/86`, selecting 41,455 of
...
4. Pick the validation that matches your adoption stage:
   ...
   | Public route matrix | `scripts/public-task-routing-matrix.sh` | You want one aggregate route-quality summary across pinned checked-in Express, FastAPI, Flask, Gin, Requests, and Streamlit expectation files. See the checked-in [public routing snapshot](docs/public-task-routing-matrix.md). |
...
- The public route-quality snapshot pins Express, FastAPI, Flask, Gin,
  ...
  selecting 41,455 of 7,098,531 task source lines, a 99.41% aggregate

...
`structuredContent` and JSON-RPC `result.content[].text` wrappers:
...
budget applies across all pages for each tool after candidate-key
deduplication; repeated file/symbol results do not consume extra slots.

...
4. Pick the validation that matches your adoption stage:
   ...
   | Public route matrix | `scripts/public-task-routing-matrix.sh` | You want one aggregate route-quality summary across the checked-in Express, Gin, Requests, and Streamlit expectation files. |

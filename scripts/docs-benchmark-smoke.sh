...
main() {
  ...
  require_pattern README.md \
    'of 38,305 source lines, avoiding 37,867 source lines before broad reading' \
  ...
  require_pattern docs/public-task-routing-matrix.md \
    'flask: 17 tasks, first files src/flask/app\.py, src/flask/blueprints\.py, src/flask/cli\.py, src/flask/config\.py, src/flask/helpers\.py, src/flask/logging\.py, src/flask/sansio/blueprints\.py, src/flask/sessions\.py, src/flask/templating\.py, src/flask/views\.py, src/flask/wrappers\.py, tests/test_testing\.py' \

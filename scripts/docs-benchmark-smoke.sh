...
main() {
  ...
  require_pattern README.md \
    'of 90,351 source lines, avoiding 89,801 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 89801 source lines, 164\.3x less text before follow-up tools\.' \

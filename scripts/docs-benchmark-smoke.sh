...
main() {
  ...
  require_pattern README.md \
    'of 90,688 source lines, avoiding 90,138 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 90138 source lines, 164\.9x less text before follow-up tools\.' \

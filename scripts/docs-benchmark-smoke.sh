...
main() {
  ...
  require_pattern README.md \
    'of 92,997 source lines, avoiding 92,443 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 92443 source lines, 167\.9x less text before follow-up tools\.' \

...
main() {
  ...
  require_pattern README.md \
    'of 91,062 source lines, avoiding 90,512 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 90512 source lines, 165\.6x less text before follow-up tools\.' \

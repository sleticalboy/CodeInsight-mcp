...
main() {
  ...
  require_pattern README.md \
    'of 89,547 source lines, avoiding 88,997 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 88997 source lines, 162\.8x less text before follow-up tools\.' \

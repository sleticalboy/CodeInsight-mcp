...
main() {
  ...
  require_pattern README.md \
    'selecting 9,693 of 363,979 task source' \
  ...
  require_pattern docs/public-task-routing-matrix.md \
    'line_reduction: 97\.33%' \
    "public task routing matrix line-reduction evidence"
  require_pattern docs/public-task-routing-matrix.md \
    'Aggregate line reduction: `97\.33%`' \
  ...
  require_pattern docs/public-task-routing-matrix.md \
    'requests: 7 tasks, first files src/requests/__init__\.py, src/requests/adapters\.py, src/requests/auth\.py, src/requests/sessions\.py' \

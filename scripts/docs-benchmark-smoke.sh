...
main() {
  ...
  require_pattern README.md \
    'selecting 17,179 of 612,740 task source' \
  ...
  require_pattern docs/public-task-routing-matrix.md \
    'express: 6 tasks, first files index\.js, lib/application\.js, lib/express\.js, lib/response\.js' \
    "public task routing matrix express summary"
  require_pattern docs/public-task-routing-matrix.md \
    'gin: 8 tasks, first files auth\.go, binding/default_validator\.go, binding/default_validator_test\.go, binding/json\.go, gin\.go, recovery\.go, render/render\.go, routergroup\.go' \
    "public task routing matrix gin summary"
  require_pattern docs/public-task-routing-matrix.md \
    'flask: 8 tasks, first files src/flask/app\.py, src/flask/cli\.py, src/flask/config\.py, src/flask/logging\.py, src/flask/sansio/blueprints\.py, src/flask/sessions\.py, src/flask/templating\.py, tests/test_testing\.py' \

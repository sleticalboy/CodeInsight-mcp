...
main() {
  ...
  require_pattern README.md \
    'selecting 13,308 of 479,185 task source' \
  ...
  require_pattern docs/public-task-routing-matrix.md \
    'requests: 10 tasks, first files src/requests/__init__\.py, src/requests/adapters\.py, src/requests/auth\.py, src/requests/sessions\.py, tests/test_adapters\.py' \

...
main() {
  ...
  require_pattern docs/public-task-routing-matrix.md \
    'streamlit: 2 tasks, first files lib/streamlit/config\.py, lib/streamlit/web/bootstrap\.py' \
  ...
  require_pattern docs/status.md \
    'passes `68/68` expected first-file checks' \
    "status public route-quality pass count"
  require_pattern docs/status.md \
    '32,190 of 2,416,275 task source lines' \

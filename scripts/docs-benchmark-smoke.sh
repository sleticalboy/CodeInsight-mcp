...
main() {
  ...
  require_pattern README.md \
    'of 93,589 source lines, avoiding 93,036 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 93036 source lines, 169\.2x less text before follow-up tools\.' \

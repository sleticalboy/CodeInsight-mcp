...
main() {
  ...
  require_pattern README.md \
    'of 93,788 source lines, avoiding 93,235 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 93235 source lines, 169\.6x less text before follow-up tools\.' \

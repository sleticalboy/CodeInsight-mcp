...
main() {
  ...
  require_pattern README.md \
    'selecting 12,125 of 442,511 task source' \
  ...
  require_pattern docs/public-task-routing-matrix.md \
    'flask: 5 tasks, first files src/flask/app\.py, src/flask/cli\.py, src/flask/config\.py, src/flask/sansio/blueprints\.py, tests/test_testing\.py' \

...
main() {
  ...
  require_pattern docs/public-task-routing-matrix.md \
    'express: 16 tasks, first files index\.js, lib/application\.js, lib/express\.js, lib/request\.js, lib/response\.js' \
    "public task routing matrix express summary"
  require_pattern docs/public-task-routing-matrix.md \
    'gin: 19 tasks, first files auth\.go, binding/default_validator\.go, binding/default_validator_test\.go, binding/json\.go, binding/query\.go, context\.go, gin\.go, recovery\.go, render/render\.go, routergroup\.go, tree\.go' \

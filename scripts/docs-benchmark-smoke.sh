...
main() {
  ...
  require_pattern README.md \
    'selecting 16,275 of 567,163 task source' \
  ...
  require_pattern docs/public-task-routing-matrix.md \
    'express: 5 tasks, first files index\.js, lib/application\.js, lib/express\.js, lib/response\.js' \
    "public task routing matrix express summary"
  require_pattern docs/public-task-routing-matrix.md \
    'gin: 7 tasks, first files auth\.go, binding/default_validator\.go, binding/default_validator_test\.go, binding/json\.go, gin\.go, render/render\.go, routergroup\.go' \

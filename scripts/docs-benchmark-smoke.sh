...
main() {
  ...
  require_pattern README.md \
    'of 90,220 source lines, avoiding 89,670 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 89670 source lines, 164\.0x less text before follow-up tools\.' \

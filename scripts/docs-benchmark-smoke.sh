...
main() {
  ...
  require_pattern README.md \
    'of 89,468 source lines, avoiding 88,918 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 88918 source lines, 162\.7x less text before follow-up tools\.' \

...
main() {
  ...
  require_pattern README.md \
    'selecting 14,644 of 503,249 task source' \
  ...
  require_pattern docs/public-task-routing-matrix.md \
    'gin: 6 tasks, first files auth\.go, binding/default_validator\.go, binding/default_validator_test\.go, binding/json\.go, gin\.go, routergroup\.go' \
    "public task routing matrix gin summary"
  require_pattern docs/public-task-routing-matrix.md \
    'flask: 7 tasks, first files src/flask/app\.py, src/flask/cli\.py, src/flask/config\.py, src/flask/logging\.py, src/flask/sansio/blueprints\.py, src/flask/sessions\.py, tests/test_testing\.py' \

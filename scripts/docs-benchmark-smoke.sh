...
main() {
  ...
  require_pattern README.md \
    'of 90,604 source lines, avoiding 90,054 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 90054 source lines, 164\.7x less text before follow-up tools\.' \

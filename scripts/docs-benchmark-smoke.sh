...
main() {
  ...
  require_pattern README.md \
    'selecting 12,719 of 460,848 task source' \
  ...
  require_pattern docs/public-task-routing-matrix.md \
    'flask: 6 tasks, first files src/flask/app\.py, src/flask/cli\.py, src/flask/config\.py, src/flask/sansio/blueprints\.py, src/flask/sessions\.py, tests/test_testing\.py' \

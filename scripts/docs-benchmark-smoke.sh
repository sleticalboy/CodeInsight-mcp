...
main() {
  ...
  require_pattern docs/public-task-routing-matrix.md \
    'gin: 16 tasks, first files auth\.go, binding/default_validator\.go, binding/default_validator_test\.go, binding/json\.go, binding/query\.go, context\.go, gin\.go, recovery\.go, render/render\.go, routergroup\.go, tree\.go' \
    "public task routing matrix gin summary"
  require_pattern docs/public-task-routing-matrix.md \
    'flask: 14 tasks, first files src/flask/app\.py, src/flask/blueprints\.py, src/flask/cli\.py, src/flask/config\.py, src/flask/helpers\.py, src/flask/logging\.py, src/flask/sansio/blueprints\.py, src/flask/sessions\.py, src/flask/templating\.py, src/flask/wrappers\.py, tests/test_testing\.py' \

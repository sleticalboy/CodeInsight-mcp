...
main() {
  ...
  require_pattern README.md \
    'of 78,072 source lines, avoiding 77,519 source lines before broad reading' \
  ...
  require_pattern docs/status.md \
    'passes `88/88` expected first-file checks' \
    "status public route-quality pass count"
  require_pattern docs/status.md \
    '41,278 of 7,115,162 task source lines' \

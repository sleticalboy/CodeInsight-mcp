...
main() {
  ...
  require_pattern README.md \
    'of 90,092 source lines, avoiding 89,542 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 89542 source lines, 163\.8x less text before follow-up tools\.' \

...
main() {
  ...
  require_pattern docs/status.md \
    'passes `74/74` expected first-file checks' \
    "status public route-quality pass count"
  require_pattern docs/status.md \
    '34,514 of 5,755,443 task source lines' \

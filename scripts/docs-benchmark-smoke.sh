...
main() {
  ...
  require_pattern README.md \
    'of 93,618 source lines, avoiding 93,065 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 93065 source lines, 169\.3x less text before follow-up tools\.' \

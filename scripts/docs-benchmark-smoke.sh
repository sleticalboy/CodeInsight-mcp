...
main() {
  ...
  require_pattern README.md \
    'of 93,222 source lines, avoiding 92,669 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 92669 source lines, 168\.6x less text before follow-up tools\.' \

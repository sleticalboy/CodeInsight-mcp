...
main() {
  ...
  require_pattern README.md \
    'of 91,621 source lines, avoiding 91,071 source lines before broad reading' \
  ...
  require_pattern docs/demo-script.md \
    'Read less: avoided 91071 source lines, 166\.6x less text before follow-up tools\.' \

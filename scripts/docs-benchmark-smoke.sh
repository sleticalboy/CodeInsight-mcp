...
expected_readme = "- The CodeInsight self adoption report packages a full tar.gz handoff and\n" \
  ...
  "  filter, reporting high route quality from 7 evidence signals"
...
assert_includes(
  ...
  "Express, FastAPI, Flask, Gin, Requests, Streamlit, and Wouter pass `#{checks}` expected first-file checks."
)
assert_includes(
  root,
  "docs/public-demo-one-pager.md",
...
main() {
  ...
  require_pattern README.md \
    '234\.1x aggregate read-less ratio' \
  ...
  require_pattern README.md \
    'of 95,016 source lines, avoiding 94,469 source lines before broad reading' \
  ...
  require_pattern README.md \
    ...
    "README external beta handoff example link"
  require_pattern README.md \
  ...
  require_pattern docs/README.md \
    ...
    "docs index Wouter task routing expectation link"
  require_pattern docs/README.md \
    '\[CodeInsight self adoption report\]\(adoption-report-codeinsight\.md\)' \
  ...
  require_pattern docs/external-beta-trial.md \
    'manifest\.json' \
    "External Beta handoff manifest artifact"
  require_pattern docs/external-beta-trial.md \
    '\[External Beta handoff example\]\(external-beta-handoff-example\.md\)' \
    "External Beta handoff example link"
  require_pattern docs/external-beta-handoff-example.md \
    'External Beta Cohort Handoff' \
    "External Beta handoff example title"
  require_pattern docs/external-beta-handoff-example.md \
    'scripts/external-beta-cohort-report\.sh' \
  ...
  require_pattern docs/external-beta-handoff-example.md \
    ...
    "External Beta handoff example manifest stage"
  require_pattern docs/external-beta-handoff-example.md \
    '"manifest\.json"' \
    "External Beta handoff example manifest file"
  require_pattern docs/external-beta-trial.md \
  ...
  require_pattern docs/task-routing-matrix.md \
    '\[Wouter\]\(task-routing-expectations/wouter\.tsv\)' \
    "task routing matrix Wouter expectation example link"
  require_pattern docs/task-routing-matrix.md \
  ...
  require_pattern docs/task-routing-expectations/wouter.tsv \
    $'understand wouter route matching flow\tpackages/wouter/src/index\\.js' \
    "Wouter task routing expectation route matching row"
  require_pattern docs/task-routing-matrix.md \
    '\| understand gin engine routing behavior \| `routergroup\.go` \|' \
  ...
  require_pattern README.md \
    '7,142,226 task source lines' \
    "README public route-quality headline"
  require_pattern README.md \
    'Express, FastAPI, Flask, Gin, Requests, Streamlit, and Wouter expectation files' \
  ...
  require_pattern docs/task-routing-matrix.md \
    'pinned Express, FastAPI, Flask, Gin, Requests, Streamlit,' \
  ...
  require_pattern docs/status.md \
    'passes `92/92` expected first-file checks' \
    "status public route-quality pass count"
  require_pattern docs/status.md \
    '41,664 of 7,142,226 task source lines' \

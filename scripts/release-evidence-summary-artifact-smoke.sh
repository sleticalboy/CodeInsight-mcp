...
main() {
  ...
  require_output "$output_file" "adoption_report_selected_lines: 440/33928" "adoption report routed first-read metric"
  require_output "$output_file" "adoption_report_line_reduction: 98.7%" "adoption report line reduction"
  require_output "$output_file" "adoption_report_type_relation_edges: 7" "adoption report type-relation edge count"
  require_output "$output_file" "adoption_report_top_type_relation_target: EmbeddingProvider" "adoption report top type-relation target"
  require_output "$output_file" "adoption_report_type_relation_filter: base_type" "adoption report type-relation graph filter"
  ...
  require_output "$output_file" "agent_route_first_selection_rank: " "agent-route first selection rank"
  require_output "$output_file" "agent_route_first_selection_reason: " "agent-route first selection reason"
  require_output "$output_file" "agent_route_continuation_status: " "agent-route continuation status"
  require_output "$output_file" "agent_route_continuation_next_action: " "agent-route continuation next action"
  ...
  require_output "$output_file" "- Agent-route first selection: rank " "release notes agent-route first selection"
  require_output "$output_file" "- Agent-route continuation: " "release notes agent-route continuation"
  ...
  require_output "$output_file" "- Adoption report type-relation routing: " "release notes adoption report type-relation routing"

  ...
  cat >"$handoff_json" <<'EOF'
{
  ...
  "post_release": {
    ...
    "installed_quickstart": {
      ...
      "skipped": true,
      "coverage": ["version", "index", "overview", "context-pack", "agent_route_execution_plan", "current_reading_step", "reading_plan_focus", "reading_plan_question", "reading_plan_reason", "selection_reason", "selection_rank", "continuation_evidence"]
    }
  },

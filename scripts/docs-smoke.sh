...
main() {
  ...
  smoke_run_step "$SMOKE_TOTAL" 13 "adoption report smoke" "$ROOT_DIR/scripts/adoption-report-smoke.sh"
  smoke_run_step "$SMOKE_TOTAL" 14 "competitive routing smoke" "$ROOT_DIR/scripts/competitive-routing-smoke.sh"

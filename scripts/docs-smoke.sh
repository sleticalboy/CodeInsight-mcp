...
main() {
  ...
  smoke_run_step "$SMOKE_TOTAL" 8 "adoption evidence smoke" "$ROOT_DIR/scripts/adoption-evidence-smoke.sh"
  smoke_run_step "$SMOKE_TOTAL" 9 "adoption report smoke" "$ROOT_DIR/scripts/adoption-report-smoke.sh"

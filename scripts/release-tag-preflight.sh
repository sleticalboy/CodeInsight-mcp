...
main() {
  ...
  require_pretag_evidence "$PRETAG_OUTPUT" "benchmark_context_pack_first:" "benchmark routing summary"
  require_pretag_evidence "$PRETAG_OUTPUT" "benchmark_line_reduction:" "benchmark line reduction summary"
  require_pretag_evidence "$PRETAG_OUTPUT" "benchmark_guardrail_failures:" "benchmark guardrail summary"
  require_pretag_evidence "$PRETAG_OUTPUT" "benchmark_truncated_packs:" "benchmark truncated context pack summary"

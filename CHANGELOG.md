...
- Benchmark profiles can assert static symbol guardrails; the large Express fixture now checks function-value and object literal method symbols such as `createError`, `handleError`, `User.index`, and `users.list`.

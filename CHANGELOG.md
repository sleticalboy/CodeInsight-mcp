...
- JavaScript and TypeScript package resolution now treats `catalog:` dependency versions as external catalog references instead of local workspace package references.
